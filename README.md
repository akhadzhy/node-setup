...
rm chainweb-node
wget https://github.com/kadena-io/chainweb-node/releases/download/2.6/chainweb-2.6.ghc-8.10.4.ubuntu-20.04.69e8a5b.tar.gz
tar -xvf chainweb-2.6.ghc-8.10.4.ubuntu-20.04.69e8a5b.tar.gz
